...
public class Task4 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] arr2;
        while(true) {
            System.out.println("Размерность первого массива: ");
            int count1 = Integer.parseInt(reader.readLine());
            if (count1 < 4) {
                System.out.println("Не менее 4 целых чисел");
                continue;
            }
            arr1 = new int[count1];
            System.out.println("Элементы первого массива(через пробел):");
            String[] string1 = reader.readLine().split(" ");
            if(string1.length!=count1){
                System.out.println("Введено неверное кол-во значений");
                continue;
            }
        ...
        while(true){
            System.out.println("Размерность второго массива: ");
            ...
            arr2 = new int[count2];
            System.out.println("Элементы второго массива(через пробел):");
        ...
        set(arr1, arr2);
        System.out.println("Итоговый массив: " + Arrays.toString(get()));
    }
